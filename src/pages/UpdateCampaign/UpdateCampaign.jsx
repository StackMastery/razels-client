...
const UpdateCampaign = () => {  
    ...
    const handelUpdate = (e) => {
        ...
        urlencoded.append("campDeadline", moment(formTarget.campDeadline.value, 'YYYY-MM-DD').toISOString());
        ...
        fetch(`${import.meta.env.VITE_BACKEND_URL}/api/updatecampaign`, requestOptions)
    ...
    return (
        <>
            <Helmet>
                <title>Update Campaign | Razels</title>
            </Helmet>
            {
                succesModal && (
                    <section className='w-full fixed h-screen items-center flex justify-center z-[9999999999999999] bg-[#1b1b1b43] px-10     py-40'>
                        <div  className="flex space-y-5 flex-col items-center p-10 justify-center w-full lg:w-5/12 2xl:w-[500px] bg-white  dark:bg-slate-800 dark:border-border-1 rounded-2xl">
                            ...
                            <div className='text-center'>
                                <h2 className='text-2xl dark:text-white font-medium'>Campaign updated Succes</h2>
            ...
            <section className="flex justify-center">
                <div className="w-primary pt-24 px-5 overflow-y-hidden">
                    <div className="w-full p-7 md:p-10 border bg-pattern dark:border-border-1 flex justify-between items-center rounded-3xl flex-col lg:flex-row">
                        ...
                        <JackInTheBox>
                            <img width={100} src={UpdateImage} alt="Power" className='animate-pulse opacity-40 lg:opacity-100 -mt-20 lg:m-0 z-10'/>
                        </JackInTheBox>
                    </div>
                </div>
            </section>
            <section className="flex justify-center">
                <form onSubmit={handelUpdate} className="w-primary flex flex-col-reverse lg:flex-row px-5 py-10 gap-10">
                    <div className="w-full lg:w-8/12 p-7 space-y-5 md:p-10 border dark:border-border-1 rounded-3xl">
                        ...
                        <div>
                            ...
                            <Select defaultValue={updateCampaign?.category} name="campCategory">
                                <SelectTrigger className="w-full">
                                    <SelectValue defaultValue={updateCampaign?.category} className="!capitalize" placeholder={updateCampaign?.category?.split("-")?.join(" ")} />
                                </SelectTrigger>
                                <SelectContent>
                                    <SelectGroup>
                        ...
                        <div className="flex justify-between gap-5 w-full flex-col sm:flex-row">
                            ...
                            <div className="sm:w-6/12 flex-grow">
                                ...
                                <input
                                    name="campDeadline"
                                    defaultValue={updateCampaign && moment(updateCampaign?.deadline).format("YYYY-MM-DD")}
                                    type="date"
                        ...
                        <div>
                            {
                                updateCampaign && (
                                    <Tiptap content={content} defaultContent={updateCampaign?.description} setContent={setContent}/>
                                )
                            }
                        </div>
                        <div className='w-full flex justify-end'>
                    ...
                    <div className='w-full lg:w-4/12'>
                        <input onChange={handelUploadImage} ref={thumbInput} name="thumb" id='thumb' className='hidden' type="file" />
