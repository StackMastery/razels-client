                ...
                <div className="w-primary px-5 pt-20 flex flex-col justify-center items-start">
                    <div className="w-full flex flex-wrap justify-between items-center border-b pb-5 dark:border-border-1 gap-4">
                        ...
                        >
                            ...
                            <p>Razels All Active Crowdfunding Campaigns</p>
                        </div>
                        <div
                        ...
                        : (
                            campaignsData.map((camp, index) => (
                                ...
                                >
                                    ...
                                    <div className="pt-5 flex flex-col gap-3">
                                        <h2 className="dark:text-white text-xl font-medium">{camp?.title.slice(0, 50)} {camp?.title.length > 49 && ( <span className="font-light text-sm dark:text-stone-200 text-black">..see more</span> )}</h2>
                                        <p className="text-base" 
                                            dangerouslySetInnerHTML={{
                                                __html: camp?.description.slice(0, 130) || "No description available",
                                            }}
                                        />
                                        <button className="flex group justify-center items-center gap-2 w-full py-2 mt-5 px-5 dark:bg-border-1 rounded-xl border dark:border-border-1 text-base font-medium bg-slate-900 text-white">
                                            See more
                                            <LiaExternalLinkAltSolid className="group-hover:translate-x-2 group-hover:-translate-y-1 transition-all" size={20} />
                                        </button>
                                    </div>
                                </Link>
                            ))
